...
# vi: set ft=ruby :
#Olopez
# This file builds middleman environment in ubuntu.
...
Vagrant.configure(2) do |config|
  ...
  # accessing "localhost:8080" will access port 80 on the guest machine.
   config.vm.network "forwarded_port", guest: 4567, host: 8181
 ...
 nodejs
     ...
     git clone  https://github.com/valenciadevops/valenciadevops-middleman.git   
     cd ~/valenciadevops-middleman
     bundle install
     middleman build
   SHELL
end
